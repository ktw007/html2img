...
/* harmony export */ });
/* harmony import */ var _base_preconditions_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ELEMENT_CLIENT_ID: () => (/* binding */ ELEMENT_CLIENT_ID),
/* harmony export */   ElementClientComms: () => (/* binding */ ElementClientComms),
/* harmony export */   ElementHostEmitterImpl: () => (/* binding */ ElementHostEmitterImpl),
/* harmony export */   setupElementRequestHandlers: () => (/* binding */ setupElementRequestHandlers)
/* harmony export */ });
...
const ELEMENT_CLIENT_ID = 'canva-code-element-sdk';
class ElementHostEmitterImpl {
    async sendRenderElement(request) {
        const result = await this.comms.request(_message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.RENDER_ELEMENT, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.RenderElementRequest.serialize(request));
        const value = extractValue(result, _message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.RENDER_ELEMENT);
        return _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.RenderElementResponse.deserialize(value);
    }
    async sendSetCapability(request) {
        const result = await this.comms.request(_message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.SET_CAPABILITY, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.SetCapabilityRequest.serialize(request));
        const value = extractValue(result, _message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.SET_CAPABILITY);
        return _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.SetCapabilityResponse.deserialize(value);
    }
    async sendSetEditPanelValue(request) {
        const result = await this.comms.request(_message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.SET_EDIT_PANEL_VALUE, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.SetEditPanelValueRequest.serialize(request));
        const value = extractValue(result, _message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.SET_EDIT_PANEL_VALUE);
        return _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.SetEditPanelValueResponse.deserialize(value);
    }
    constructor(comms){
        this.comms = comms;
    }
}
function setupElementRequestHandlers(comms, handler) {
    (0,_apps_developing_sandbox_comms_comms_helpers_ts__WEBPACK_IMPORTED_MODULE_0__.handleMessageFromHost)(comms, _message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.INIT_ELEMENT, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.InitElementRequest, (request)=>handler.handleInitElement(request), _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.InitElementResponse);
    (0,_apps_developing_sandbox_comms_comms_helpers_ts__WEBPACK_IMPORTED_MODULE_0__.handleMessageFromHost)(comms, _message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.SET_CONFIG, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.SetConfigRequest, (request)=>handler.handleSetConfig(request), _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.SetConfigResponse);
    (0,_apps_developing_sandbox_comms_comms_helpers_ts__WEBPACK_IMPORTED_MODULE_0__.handleMessageFromHost)(comms, _message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.RESIZE_EVENT, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.ResizeEvent, (request)=>handler.handleResizeEvent(request));
}
class ElementClientComms {
    async sendInitElement(request) {
        const result = await this.comms.request(_message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.INIT_ELEMENT, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.InitElementRequest.serialize(request));
        const value = extractValue(result, _message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.INIT_ELEMENT);
        return _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.InitElementResponse.deserialize(value);
    }
    async sendSetConfig(request) {
        const result = await this.comms.request(_message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.SET_CONFIG, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.SetConfigRequest.serialize(request));
        const value = extractValue(result, _message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.SET_CONFIG);
        return _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.SetConfigResponse.deserialize(value);
    }
    async sendResizeEvent(event) {
        await this.comms.request(_message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.RESIZE_EVENT, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.ResizeEvent.serialize(event));
    }
    setupRequestHandlers() {
        (0,_apps_developing_sandbox_comms_comms_helpers_ts__WEBPACK_IMPORTED_MODULE_0__.handleMessageFromHost)(this.comms, _message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.RENDER_ELEMENT, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.RenderElementRequest, (request)=>{
            this.logger.info('Received RenderElementRequest', request);
            return this.handler.handleRenderElement(request);
        }, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.RenderElementResponse);
        (0,_apps_developing_sandbox_comms_comms_helpers_ts__WEBPACK_IMPORTED_MODULE_0__.handleMessageFromHost)(this.comms, _message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.SET_CAPABILITY, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.SetCapabilityRequest, (request)=>{
            this.logger.info('Received SetCapabilityRequest', request);
            return this.handler.handleSetCapability(request);
        }, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.SetCapabilityResponse);
        (0,_apps_developing_sandbox_comms_comms_helpers_ts__WEBPACK_IMPORTED_MODULE_0__.handleMessageFromHost)(this.comms, _message_paths__WEBPACK_IMPORTED_MODULE_1__.MessagePaths.SET_EDIT_PANEL_VALUE, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.SetEditPanelValueRequest, (request)=>{
            this.logger.info('Received SetEditPanelValueRequest', request);
            return this.handler.handleSetEditPanelValue(request);
        }, _payloads_proto__WEBPACK_IMPORTED_MODULE_2__.SetEditPanelValueResponse);
    }
    constructor(comms, handler, logger){
        this.comms = comms;
        this.handler = handler;
        this.logger = logger;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Borderable: () => (/* binding */ Borderable),
/* harmony export */   BorderableValue: () => (/* binding */ BorderableValue),
/* harmony export */   Dimensions: () => (/* binding */ Dimensions),
/* harmony export */   EditPanelValue: () => (/* binding */ EditPanelValue),
/* harmony export */   FontEditable: () => (/* binding */ FontEditable),
/* harmony export */   FontSizeable: () => (/* binding */ FontSizeable),
/* harmony export */   InitElementRequest: () => (/* binding */ InitElementRequest),
/* harmony export */   InitElementResponse: () => (/* binding */ InitElementResponse),
/* harmony export */   Recolorable: () => (/* binding */ Recolorable),
/* harmony export */   RenderElementRequest: () => (/* binding */ RenderElementRequest),
/* harmony export */   RenderElementResponse: () => (/* binding */ RenderElementResponse),
/* harmony export */   ResizeEvent: () => (/* binding */ ResizeEvent),
/* harmony export */   SetCapabilityRequest: () => (/* binding */ SetCapabilityRequest),
/* harmony export */   SetCapabilityResponse: () => (/* binding */ SetCapabilityResponse),
/* harmony export */   SetConfigRequest: () => (/* binding */ SetConfigRequest),
/* harmony export */   SetConfigResponse: () => (/* binding */ SetConfigResponse),
/* harmony export */   SetEditPanelValueRequest: () => (/* binding */ SetEditPanelValueRequest),
/* harmony export */   SetEditPanelValueResponse: () => (/* binding */ SetEditPanelValueResponse)
/* harmony export */ });
...
// Generated from ui/rendering/codelet/sdk/element/payloads.proto.

const InitElementRequest = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  config: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredString('config', 1)
}), {
...
const InitElementResponse = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  config: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.optionalString('config', 1),
  fontEditable: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.optionalObject('fontEditable', 2, FontEditable)
}), {
  dualDeserializationConfig: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY
});
const SetConfigRequest = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  config: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredString('config', 1),
  recolorables: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.repeatedObject('recolorables', 4, Recolorable),
  borderables: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.repeatedObject('borderables', 5, Borderable),
  fontEditable: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.optionalObject('fontEditable', 6, FontEditable),
  editPanelValues: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.repeatedObject('editPanelValues', 7, EditPanelValue),
  fontSizeable: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.optionalObject('fontSizeable', 8, FontSizeable)
}), {
  dualDeserializationConfig: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY
});
const SetConfigResponse = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({}));
const BorderableValue = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  borderRadius: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredInt32('borderRadius', 1),
  borderWidth: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredInt32('borderWidth', 2)
}), {
  dualDeserializationConfig: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY
});
const EditPanelValue = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  id: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredString('id', 1),
  value: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredString('value', 2)
}), {
  dualDeserializationConfig: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY
});
/** Host Requests */
const RenderElementRequest = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  config: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.optionalString('config', 1),
  fontEditable: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.optionalObject('fontEditable', 2, FontEditable)
}), {
  dualDeserializationConfig: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY
});
const RenderElementResponse = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  config: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredString('config', 1),
  recolorables: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.repeatedObject('recolorables', 4, Recolorable),
  borderables: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.repeatedObject('borderables', 5, Borderable),
  editPanelValues: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.repeatedObject('editPanelValues', 6, EditPanelValue),
  fontSizeable: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.optionalObject('fontSizeable', 7, FontSizeable),
  fontEditable: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.optionalObject('fontEditable', 8, FontEditable)
}), {
  dualDeserializationConfig: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY
});
const SetCapabilityRequestUnionFields = () => ({});
const SetCapabilityRequest = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createOneof(() => ({
  type: [/* A */1, Recolorable, /* B */2, Borderable, /* C */3, FontEditable, /* E */5, FontSizeable]
}), SetCapabilityRequestUnionFields, {
  dualDeserializationConfig: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY
});
const Recolorable = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  ...SetCapabilityRequestUnionFields(),
  type: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.constantString('type', 'RECOLORABLE', 1, 'RECOLORABLE'),
  id: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredString('id', 1),
  value: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredString('value', 2)
}), {
  dualDeserializationConfig: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY
});
const Borderable = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  ...SetCapabilityRequestUnionFields(),
  type: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.constantString('type', 'BORDERABLE', 2, 'BORDERABLE'),
  id: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredString('id', 1),
  value: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredObject('value', 2, BorderableValue)
}), {
  dualDeserializationConfig: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY
});
const FontEditable = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  ...SetCapabilityRequestUnionFields(),
  type: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.constantString('type', 'FONT_EDITABLE', 3, 'FONT_EDITABLE'),
  id: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredString('id', 1),
  url: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredString('url', 4)
}), {
  dualDeserializationConfig: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY
});
const FontSizeable = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  ...SetCapabilityRequestUnionFields(),
  type: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.constantString('type', 'FONT_SIZEABLE', 5, 'FONT_SIZEABLE'),
  size: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredInt32('size', 21)
}), {
  dualDeserializationConfig: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY
});
const SetCapabilityResponse = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  config: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredString('config', 1)
}), {
  dualDeserializationConfig: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY
});
const SetEditPanelValueRequest = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  id: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredString(/* A */1),
  value: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredString(/* B */2)
}));
const SetEditPanelValueResponse = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  config: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredString(/* A */1)
}));
const ResizeEvent = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  body: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredObject('body', 1, Dimensions)
}), {
  dualDeserializationConfig: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY
});
const Dimensions = _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.createMessage(() => ({
  scrollWidth: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredInt32('scrollWidth', 1),
  scrollHeight: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredInt32('scrollHeight', 2),
  offsetWidth: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredInt32('offsetWidth', 3),
  offsetHeight: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.Proto.requiredInt32('offsetHeight', 4)
}), {
  dualDeserializationConfig: _base_proto_proto_ts__WEBPACK_IMPORTED_MODULE_0__.DualDeserializationConfig.MINI_PRIMARY_FULL_SECONDARY
});
...
/* harmony import */ var _preconditions_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
...
/* harmony export */ });
/* harmony import */ var _preconditions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ElementSdkImpl: () => (/* binding */ ElementSdkImpl)
/* harmony export */ });
/* harmony import */ var _base_preconditions_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _apps_developing_sandbox_comms_connect_to_parent_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _element_comms_client_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(14);
/* harmony import */ var _element_payloads_proto_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(17);
/* harmony import */ var _error_service_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(22);
/* harmony import */ var _logger_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(23);
/* harmony import */ var _sdk_result__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(24);
// Copyright 2025 Canva Inc. All Rights Reserved.
...
/**
 * This script must be injected into the Codelet Iframe
 */ const TARGET_ORIGIN = '*';
class ElementSdkImpl {
    async setupParentCommunication() {
        const result = await this.connectToParent(this.errorService, TARGET_ORIGIN, window, _element_comms_client_ts__WEBPACK_IMPORTED_MODULE_2__.ELEMENT_CLIENT_ID);
        if (!result.ok) return _sdk_result__WEBPACK_IMPORTED_MODULE_6__.SdkResult.error(new Error('Failed to connect to parent'));
        // Setup host events emitters.
        // Note: This should be defined on all supported browsers, however, required
        // global types to be updates. See announcement: https://canva.slack.com/archives/C0BLT5L56/p1753162447383909
        if (globalThis.ResizeObserver == null) this.logger.warn('ResizeObserver is not supported');
        else {
            const observer = new globalThis.ResizeObserver((entries)=>{
                for (const entry of entries)if (entry.target === document.body) {
                    const { scrollWidth, scrollHeight, offsetWidth, offsetHeight } = document.body;
                    this.commsClient?.sendResizeEvent({
                        body: {
                            scrollWidth,
                            scrollHeight,
                            offsetWidth,
        ...
        // Setup RPC handlers
        const elementClientHandler = {
            handleRenderElement: async (request)=>{
                if (!this.element) {
                    this.logger.error('Received renderElement before Element initialized');
                    return this.queueRenderElementRequest(request);
                }
                return this.processRenderElementRequest(request);
            },
            handleSetCapability: async (request)=>{
                if (!this.element) throw new Error('Element is uninitialized');
                this.element.setCapability(request);
                return new _element_payloads_proto_ts__WEBPACK_IMPORTED_MODULE_3__.SetCapabilityResponse({
                    ...this.element.getElementData()
                });
            },
            handleSetEditPanelValue: async (request)=>{
                if (!this.element) throw new Error('Element is uninitialized');
                this.element.setEditPanelValue(request);
                return new _element_payloads_proto_ts__WEBPACK_IMPORTED_MODULE_3__.SetEditPanelValueResponse({
                    ...this.element.getElementData()
                });
            }
        };
        this.logger.info('Successfully connected to parent');
        this.commsClient = this.createElementClientComms(result.value, elementClientHandler);
        return _sdk_result__WEBPACK_IMPORTED_MODULE_6__.SdkResult.ok(this.commsClient);
    }
    /** @inheritDoc */ get config() {
        if (!this.element) throw new Error('Element is uninitialized');
        return this.element.config;
    }
    /** @inheritDoc */ async init(element) {
        this.logger.info('Initializing Element');
        const onConfigChangeFn = element.onConfigChange ?? element.render;
        if (!onConfigChangeFn) return _sdk_result__WEBPACK_IMPORTED_MODULE_6__.SdkResult.error(new Error('No render or onConfigChange function provided'));
        this.element = new Element(element.defaultConfig, onConfigChangeFn, element.mapToCapabilities, element.mapToEditPanelValues);
        // Setting up the comms client here ensures that the LLM doesn't call init
        // before the handshake has finished.
        const setupResult = await this.setupPromise;
        if (setupResult.isError) return _sdk_result__WEBPACK_IMPORTED_MODULE_6__.SdkResult.error(setupResult.error);
        const commsClient = setupResult.data;
        let processInitElementResponseResult;
        try {
            // We send in the default config initially to ensure that the host gets
            // properly initialized in the case of a fresh widget.
            // The response will contain the hydrated state if it currently exists
            const initElementResponse = await commsClient.sendInitElement(new _element_payloads_proto_ts__WEBPACK_IMPORTED_MODULE_3__.InitElementRequest({
                config: JSON.stringify(element.defaultConfig)
            }));
            processInitElementResponseResult = await this.processInitElementResponse(initElementResponse);
        } catch (e) {
            return _sdk_result__WEBPACK_IMPORTED_MODULE_6__.SdkResult.error(e instanceof Error ? e : new Error(String(e)));
        }
        if (processInitElementResponseResult.isError) return _sdk_result__WEBPACK_IMPORTED_MODULE_6__.SdkResult.error(processInitElementResponseResult.error);
        // TODO (ryanr) we probably dont need all this flush behaviour now we have an init request/response.
        if (this.flushPendingRenderRequest !== undefined) {
            this.logger.info('Processing queued request after initialization');
            this.flushPendingRenderRequest();
            this.flushPendingRenderRequest = undefined;
        }
        return _sdk_result__WEBPACK_IMPORTED_MODULE_6__.SdkResult.ok(undefined);
    }
    /** @inheritDoc */ async setConfig(config) {
        if (!this.commsClient) return _sdk_result__WEBPACK_IMPORTED_MODULE_6__.SdkResult.error(new Error('SDK is disconnected'));
        if (!this.element) return _sdk_result__WEBPACK_IMPORTED_MODULE_6__.SdkResult.error(new Error('Element is uninitialized'));
        await this.element.setConfig({
            ...this.element.config,
            ...config
        });
        await this.commsClient.sendSetConfig(new _element_payloads_proto_ts__WEBPACK_IMPORTED_MODULE_3__.SetConfigRequest({
            ...this.element.getElementData(),
            ...this.element.getCapabilityProtos(),
            ...this.element.getEditPanelValuesProtos()
        }));
        return _sdk_result__WEBPACK_IMPORTED_MODULE_6__.SdkResult.ok(undefined);
    }
    queueRenderElementRequest(request) {
        return new Promise((resolve)=>{
            this.flushPendingRenderRequest = ()=>this.processRenderElementRequest(request).then((response)=>resolve(response));
        });
    }
    async processInitElementResponse(response) {
        if (!this.element) return _sdk_result__WEBPACK_IMPORTED_MODULE_6__.SdkResult.error(new Error('Element is uninitialized'));
        await this.element.setSerializedConfig(response.config);
        if (response.fontEditable) this.element.setCapability(response.fontEditable);
        return this.setConfig(this.element.config);
    }
    async processRenderElementRequest(request) {
        if (!this.element) throw new Error('Element is uninitialized');
        await this.element.setSerializedConfig(request.config);
        if (request.fontEditable) this.element.setCapability(request.fontEditable);
        return new _element_payloads_proto_ts__WEBPACK_IMPORTED_MODULE_3__.RenderElementResponse({
            ...this.element.getElementData(),
            ...this.element.getCapabilityProtos(),
            ...this.element.getEditPanelValuesProtos()
        });
    }
    constructor(connectToParent, createElementClientComms, logger, errorService){
        this.connectToParent = connectToParent;
        this.createElementClientComms = createElementClientComms;
        this.logger = logger;
        this.errorService = errorService;
        this.setupPromise = this.setupParentCommunication();
    }
}
class Element {
    get config() {
    ...
    async setConfig(config) {
        this._config = JSON.parse(JSON.stringify(config)); // ensure config is serializable to a string
        this.editPanelValues = this.mapToEditPanelValues(this._config);
        this.capabilities = this.getCapabilities();
        return this.onConfigChange(this._config);
    }
    setSerializedConfig(config) {
        this._config = config ? {
            ...this._config,
            ...JSON.parse(config)
        } : this.defaultConfig;
    ...
    setCapability(proto) {
        switch(proto.type){
            case 'RECOLORABLE':
                const recolorable = this.capabilities.recolorables.get(proto.id);
                recolorable?.set(proto.value);
                break;
            case 'BORDERABLE':
                const borderable = this.capabilities.borderables.get(proto.id);
                borderable?.set(proto.value);
                break;
            case 'FONT_EDITABLE':
                this.loadAndSetFont(proto);
                this.capabilities.fontEditable?.set(proto.id);
                break;
            case 'FONT_SIZEABLE':
                this.capabilities.fontSizeable?.set(proto.size);
                break;
            default:
                throw new _base_preconditions_ts__WEBPACK_IMPORTED_MODULE_0__.UnreachableError(proto);
        }
    }
    async loadAndSetFont(proto) {
        const font = new FontFace(proto.id, `url(${proto.url})`);
        try {
            ...
            // eslint-disable-next-line no-console
            console.error('Failed to load font', proto.url, e);
        }
    }
    setEditPanelValue(proto) {
        this.editPanelValues.set(proto.id, proto.value);
        this._config = {
            ...this._config,
    ...
    getElementData() {
        ...
        // compute dimensions from iframe DOM
    ...
    getCapabilityProtos() {
        const recolorables = [
            ...this.capabilities.recolorables.entries()
        ].map(([id, recolorable])=>new _element_payloads_proto_ts__WEBPACK_IMPORTED_MODULE_3__.Recolorable({
                id,
                value: recolorable.get()
            }));
        const borderables = [
            ...this.capabilities.borderables.entries()
        ].map(([id, borderable])=>new _element_payloads_proto_ts__WEBPACK_IMPORTED_MODULE_3__.Borderable({
                id,
                value: borderable.get()
            }));
        // We intend to return a FontEditable here to indicate that the generated codelet
        // has font editable functionality; the intention isn't to use this returned
        // object for font retrieval and loading. The LLM is only aware of fonts having
        // an id and do not build out a url, so you will see that the id is stored twice
        // as the id and as the url.
        const fontEditable = this.capabilities.fontEditable ? new _element_payloads_proto_ts__WEBPACK_IMPORTED_MODULE_3__.FontEditable({
            id: this.capabilities.fontEditable.get(),
            url: ''
        }) : undefined;
        const fontSizeable = this.capabilities.fontSizeable ? new _element_payloads_proto_ts__WEBPACK_IMPORTED_MODULE_3__.FontSizeable({
            size: this.capabilities.fontSizeable.get()
        }) : undefined;
        return {
            recolorables,
            borderables,
    ...
    getEditPanelValuesProtos() {
        return {
            editPanelValues: [
                ...this.editPanelValues.entries()
            ].map(([id, value])=>new _element_payloads_proto_ts__WEBPACK_IMPORTED_MODULE_3__.EditPanelValue({
                    id,
                    value
                }))
        };
    ...
    getCapabilities() {
        const capabilities = this.mapToCapabilities(this._config);
        const recolorables = new Map();
        capabilities.recolorables.forEach((recolorable, index)=>{
            const id = `recolorable-${index}`;
            recolorables.set(id, recolorable);
        });
        const borderables = new Map();
        if (capabilities.borderables?.length > 0) {
            const borderable = {
                get: ()=>capabilities.borderables[0].get(),
                set: (value)=>{
                    capabilities.borderables.forEach((borderable)=>borderable.set(value));
                }
            };
            borderables.set('borderable', borderable);
        }
        const { fontEditable, fontSizeable } = capabilities;
        return {
            recolorables,
            borderables,
            fontEditable,
    ...
    constructor(defaultConfig, onConfigChange, mapToCapabilities, mapToEditPanelValues){
...
const logger = new _logger_ts__WEBPACK_IMPORTED_MODULE_5__.Logger('Element');
const errorService = new _error_service_ts__WEBPACK_IMPORTED_MODULE_4__.ErrorServiceImpl(logger);
// eslint-disable-next-line @canva/ts/no-window-outside-extern-imports
window.elementSdk = new ElementSdkImpl(_apps_developing_sandbox_comms_connect_to_parent_ts__WEBPACK_IMPORTED_MODULE_1__.connectToParent, (connection, handler)=>new _element_comms_client_ts__WEBPACK_IMPORTED_MODULE_2__.ElementClientComms(connection, handler, logger), logger, errorService);
